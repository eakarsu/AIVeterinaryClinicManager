...
// Feature: Wellness reminder automation by species/age
...
export default function CfWellnessReminderAutomationBySpeciesAge() {
  ...
  const submit = async (e) => {
    ...
    try {
      const res = await fetch(`${API_BASE}/api/cf-wellness-reminder-automation-by-species-age/run`, {
        method: 'POST', headers: getHeaders(),
        body: JSON.stringify({ prompt: input, feature: 'cf-wellness-reminder-automation-by-species-age', project: 'AIVeterinaryClinicManager' })
      })
  ...
  const loadHistory = async () => {
    try {
      const res = await fetch(`${API_BASE}/api/cf-wellness-reminder-automation-by-species-age/history`, { headers: getHeaders() })
      const data = await res.json()
  ...
  return (
    <div className="max-w-4xl mx-auto p-4">
      <div className="mb-4">
        <h1 className="text-2xl font-bold text-slate-800">Wellness reminder automation by species/age</h1>
